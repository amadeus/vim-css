...
syntax match  cssPropDefinition       contained /font-family\%([ \r\t\n]*:\)\@=/ nextgroup=cssFontFamilyValueBlock skipwhite skipempty contains=cssProp,cssBrowserPrefix
syntax region cssValueBlock           contained matchgroup=cssValueBlockDelimiters start=/:/ end=/;/ contains=@cssValues
syntax region cssFontFamilyValueBlock contained matchgroup=cssValueBlockDelimiters start=/:/ end=/;/ contains=cssString,cssValueNoise
...
highlight! default link cssFontFamilyValueBlock    Constant
