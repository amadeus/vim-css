...
syntax match cssProp contained /\%(animation-timing-function\|animation-play-state\|animation-name\|animation-iteration-count\|animation-fill-mode\|animation-duration\|animation-direction\|animation-delay\|animation\|all\|alignment-baseline\|align-self\|align-items\|align-content\)\>/
...
syntax match cssValueKeyword contained /\%(col-resize\|clip\|center\|cell\|caption\|capitalize\|button\|break-word\|bottom\|both\|border-box\|bolder\|bold\|block\|block\|baseline\|backwards\|auto\|antialiased\|alternate-reverse\|alternate\|all-scroll\|alias\|absolute\)\>/
