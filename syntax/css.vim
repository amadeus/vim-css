...
syntax match cssProp /\%(quotes\|presentation-level\|position\|polar-origin\|polar-distance\|polar-angle\|polar-anchor\|pointer-events\|play-during\|pitch-range\|pitch\|perspective-origin\|perspective\|pause-before\|pause-after\|pause\|page-policy\|page-break-inside\|page-break-before\|page-break-after\|page\|padding-top\|padding-right\|padding-left\|padding-bottom\|padding\|overflow-y\|overflow-x\|overflow-wrap\|overflow-style\|overflow\|outline-width\|outline-style\|outline-offset\|outline-color\|outline\|osx-font-smoothing\|orphans\|order\|opacity\|offset-start\|offset-end\|offset-before\|offset-after\|object-position\|object-fit\|nav-up\|nav-right\|nav-left\|nav-down\|move-to\|motion-rotation\)\>/
